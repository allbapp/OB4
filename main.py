...
#Цель: Цель этого домашнего задание - закрепить понимание и навыки применения принципа открытости
# /закрытости (Open/Closed Principle),
...
# чтобы легко можно было добавлять новые типы оружия, не изменяя существующий код бойцов
# или механизм боя.
...
fighter.weapon.attack(fighter.weapon)
